...
📌 Install & Update:
```
bash <(curl -Ls https://github.com/geeksmax/SSH-Pro/raw/main/install.sh --ipv4)
```
...
📌 Voice & Video Call:
```
bash <(curl -Ls https://github.com/geeksmax/SSH-Pro/raw/main/ssh-calls.sh --ipv4)
```
...
📌 Install SSL:
```
bash <(curl -Ls https://github.com/geeksmax/SSH-Pro/raw/main/ssl.sh --ipv4)
```
...
```
bash <(curl -Ls https://github.com/geeksmax/SSH-Pro/raw/main/blockiran.sh)
```
